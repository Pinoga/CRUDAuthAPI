...
// Verificação da autenticação do token vindo do cliente e retorno dos dados do usuário
UserRouter.post('/authenticate', JWTVerifiedCallback, UserController.authenticate);
